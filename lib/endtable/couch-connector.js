...
var StackProcessor = require('./stack-processor').StackProcessor;
...
exports.connector = Class.extend({
	...
	createView: function(params, callback) {
		...
		this.connection.getDoc(documentName, function(error, doc) {
			...
			_this.stackProcessor.runSynchronous(_this, function(documentName, doc, callback) {
				this.connection.saveDoc(
					documentName,
					doc,
					function() {
						callback();
						_this.stackProcessor.next();	
					}
				);
